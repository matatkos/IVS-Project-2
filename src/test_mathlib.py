#Importing functions from mathlib
...
class Test_ADD:
    ...
    #testing positive and negative numbers together
...
class Test_Div():
    ...
    def test_div_positive(self):
        ...
        assert ml.div(0, 4) == 0
        assert ml.div(5, 0) == ml.error_message_1 #edge case- division by zero
    #testing negative numbers
...
class Test_Root():
    ...
    #testing negative numbers with odd root
...
#Testing '!' function
class Test_Fact():
    #testing for decimal and negative numbers - expected error
    ...
    #testing positive non decimal numbers
...
class Test_Power():
    ...
    def test_pow_decim(self):
        ...
        assert ml.pow(-2, 3.99) == ml.error_message_root #expected error message - one of the root rules were broken
